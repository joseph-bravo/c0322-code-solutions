...
const { title: titleOther, author: authorOther, libraryID: libraryIDOther } = book2;
console.log(`The title of the book is ${titleOther}, the author is ${authorOther}, and the library id is ${libraryIDOther}`);
